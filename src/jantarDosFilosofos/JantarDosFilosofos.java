...
public class JantarDosFilosofos {
    ...
    static void pegar_garfos(int id) throws InterruptedException {
        ...
        try {
            estado[id] = FAMINTO;
            System.out.println("Filósofo " + id + " está tentando pegar os garfos " + id + " e " + ESQUERDA(id));
            testar(id);
        } finally {
            mutex.release();
        }
        semaforos[id].acquire();
        System.out.println("Filósofo " + id + " pegou os garfos " + id + " e " + ESQUERDA(id));
    }
    ...
    static void colocar_garfos(int id) throws InterruptedException {
        ...
        try {
            estado[id] = PENSANDO;
            System.out.println("Filósofo " + id + " largou os garfos " + id + " e " + ESQUERDA(id));
            testar(ESQUERDA(id));
            testar(DIREITA(id));
        } finally {
            mutex.release();
